    ...
    <div class="statisticsBlock tabShowBlock" v-show="this.tab === 2">
        ...
        <div class="traceTable statisticsTable">
            ...
            <div class="table">
                ...
                <table>
                    <tr>
                        <td scope="col" class="manufactureName">流程</td>
                        <td scope="col" class="machineName">生產機台</td>
                        <td scope="col" class="produce">累積生產量 (顆)</td>
                        <td scope="col" class="passRatio">良率 (%)</td>
                        <td scope="col" class="finishRatio">完成率 (%)</td>
                        <td scope="col" class="estimateFinishTime">累積花費時間</td>
                        <td scope="col" class="finishTime">預估完成時間</td>
                    </tr>
